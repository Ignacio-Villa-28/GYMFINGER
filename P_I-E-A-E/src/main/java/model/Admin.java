...
public class Admin {
    ...
    public Admin(String nombre, String apellidoPaterno, String apellidoMaterno, int edad, String sexo, String matricula, String seguroFacultativo, String pais, String licenciatura, Date fechaRegistro, byte[] huella) {
        this.nombre = nombre;
